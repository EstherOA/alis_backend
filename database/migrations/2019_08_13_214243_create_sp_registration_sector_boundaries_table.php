...
class CreateSpRegistrationSectorBoundariesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sp_registration_sector_boundaries', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('sp_registration_sector_boundaries');
    }
}
